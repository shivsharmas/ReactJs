  ...
  return (
    ...
    <div className="dropdown">
      <a href="#" className="d-flex align-items-center text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
        <img src="https://avatars.githubusercontent.com/u/175924732?s=400&u=e3bcd9eba8acdaa9d681b5490e1da42512d9e8d9&v=4" alt="" width="32" height="32" className="rounded-circle me-2" />
